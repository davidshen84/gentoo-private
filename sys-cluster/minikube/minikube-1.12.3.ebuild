...
EAPI=7
inherit go-module
GIT_COMMIT=10f79023c412f3504d7ff4a6ffe432ab57d2ba29
...
EGO_SUM=(
	...
	"github.com/afbjorklund/go-containerregistry v0.0.0-20200602203322-347d93793dc9"
	"github.com/afbjorklund/go-containerregistry v0.0.0-20200602203322-347d93793dc9/go.mod"
...
PATCHES=(
	"${WORKDIR}/${PN}-${PV}/0001-Squashed-commit-of-the-following.patch"
)
...
src_prepare() {
	unpack "${FILESDIR}/0001-Squashed-commit-of-the-following.patch.bz2"
	default
}
