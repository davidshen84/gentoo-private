...
src_compile() {
	emake WITH_LIBELF="yes" WITH_TIRPC="yes" WITH_SECCOMP="$(usex seccomp)" CURL="echo" TAR="echo" \
		  GIT_TAG="1.14.3" GIT_COMMIT="1eb5a30a6ad0415550a9df632ac8832bf7e2bbba" REVISION="1eb5a30a6ad0415550a9df632ac8832bf7e2bbba" \
		  all
}
